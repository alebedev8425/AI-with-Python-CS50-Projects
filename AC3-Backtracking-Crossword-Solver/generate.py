...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        # check membership
        if y not in self.domains or x not in self.domains:
            return revised
        if self.crossword.overlaps[x, y] is None:
            ...
            for wordX in list(self.domains[x]):
                if not any(wordX[i] == wordY[j] for wordY in list(self.domains[y])):
    ...
    def consistent(self, assignment):
        ...
        for var in self.crossword.variables:
            if var in assignment:
                ...
                for n in neighbors:
                    if n not in assignment or assignment[n] is None:
                        continue
    ...
    def select_unassigned_variable(self, assignment):
        ...
        lowest = min(unassigned, key=lambda x: len(self.domains[x]))
